...
function setTime() {
    var create_time = Math.round(new Date(Date.UTC(2023, 11, 8, 0, 0, 0)).getTime() / 1000);
    var timestamp = Math.round((new Date().getTime() + 8 * 60 * 60 * 1000) / 1000);
    currentTime = secondToDate((timestamp - create_time));
    currentTimeHtml = currentTime[0] + '年' + currentTime[1] + '日'
        + currentTime[2] + '時間' + currentTime[3] + '分' + currentTime[4]
        + '秒';
